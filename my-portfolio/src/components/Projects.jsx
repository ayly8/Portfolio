...
// this component maps over all project data and displays each one
function Projects() {
   const projects = projectsData;

   return (
      <div className="overflow-x-hidden">
         <h2 className="text-[#dd127f] p-[15px] mx-auto md:pb-0 md:ml-[355px]">+.* Projects +.*</h2>
         <div className="grid grid-cols-1 m-0 md:grid-cols-2 md:w-[calc(100%-355px)] md:ml-[355px]">
