...
function AboutMe() {
   return (
      <div className="border-2 border-[#dd127f] rounded-[10px] shadow-[5px_5px_5px_#FBACBE] bg-white p-[15px] m-5 static
         md:fixed md:top-[55px] md:w-[300px] md:h-[calc(95vh-55px)] md:overflow-y-auto">
         ...
         <p>
            ...
            these skills in a professional tech environment. I enjoy spending time with loved ones, doing art, and playing games in my free time!
         </p>
